...
cfg1.add_prod('S', 'P .   P')
cfg1.add_prod('S',  'GN GV | CCT GN GV| CCL  GN GV PropSub|  GN GV CCL')
cfg1.add_prod('CCAvecAdv','Ne sachant pas conduire | Ayant conscience de la fragilité de la vie')
cfg1.add_prod('CCL', 'dans la vallée de Dana | au pied du lit | à l esgi | a paris')
